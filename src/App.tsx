...
import { Link, Routes, Route, useNavigate, BrowserRouter as Router, useLocation } from 'react-router-dom';
...
// Lazy load components with proper named exports
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="flex justify-between items-center">
            ...
            >
              <a href="#" className="flex items-center">
                <div
                  className={`bg-secondary py-1 px-3 rounded-sm shadow-md mr-2 transition-all duration-300 ${
            ...
            <div className="hidden lg:flex items-center space-x-6 xl:space-x-8">
              ...
              <div className="flex items-center pl-2 border-l border-gray-300/30">
                ...
                <Button
                  ...
                  size="sm"
                  className={`text-sm ${
                    !scrolled && 'border-white text-white hover:bg-white/20'
                  }`}
                >
                  ENQUIRE NOW
                </Button>
      ...
      <section
        ...
        style={{
          backgroundImage:
            'url("https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&q=80&w=1920&h=1080")',
          ...
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <div className="max-w-4xl mx-auto text-center">
              <p className="text-gray-600 text-base sm:text-lg mb-8 sm:mb-10 leading-relaxed px-2 sm:px-0">
                Embark on a life beyond the ordinary, where the boundaries between nature and
                city life seamlessly merge. Nestled in Vikhroli East, presenting Swastik
                Platinum, an exclusive haven with 1 & 2 BHK luxurious balcony residences.
                Escape the mundane as your balcony transforms into a sanctuary, granting you
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6">
                <Button
                  ...
                  onClick={() =>
                    downloadFile('/assets/brochure.pdf', 'SwastikPlatinum-Brochure.pdf')
                  }
                >
                ...
                <Button
                  ...
                  onClick={() =>
                    downloadFile('/assets/floorplans.pdf', 'SwastikPlatinum-FloorPlans.pdf')
                  }
                >
      ...
      <AnimatedSection>
        <section id="configurations" className="py-20 bg-accent">
          <div className="container mx-auto px-6">
            ...
            <h3 className="text-xl text-center mb-4 text-gray-600 font-light">
      ...
      <AnimatedSection>
        <section id="location" className="py-20 bg-white">
          <div className="container mx-auto px-6">
            <h3 className="font-heading text-4xl font-bold text-center mb-4">LOCATION</h3>
            <h3 className="text-xl text-center mb-4 text-gray-600 font-light">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
            <div>
              ...
              <p className="mb-4 sm:mb-6 text-white/80 text-sm sm:text-base">
                Luxury residences in Vikhroli East, Mumbai
              </p>
              <div className="space-y-3 sm:space-y-4">
                <p className="flex items-start gap-3">
                  <MapPin className="w-5 h-5 mt-0.5 text-secondary flex-shrink-0" />
                  <span className="text-white/80 text-sm sm:text-base">
                    312, Swastik Disa Corporate Park, Opp. Shreyas Cinemas, LBS Rd,
            ...
            <div className="mt-8 sm:mt-0">
              <h3 className="font-heading text-lg sm:text-xl font-bold mb-4 sm:mb-6 bg-secondary py-1 px-3 rounded-sm shadow-md inline-block mb-6">
                Quick Links
              </h3>
              <ul className="grid grid-cols-2 sm:grid-cols-1 gap-2 sm:gap-4">
                <li>
                  <a
                    href="#overview"
                    className="text-white/80 hover:text-secondary transition-colors text-sm sm:text-base"
                  >
                    Overview
                  </a>
                </li>
            ...
            <div>
              ...
              <div className="flex gap-4 mb-8">
                <a
                  href="https://www.facebook.com/Swastikgroupdevelopers/"
                  target="_blank"
                  className="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center hover:bg-secondary hover:border-secondary transition-colors"
                >
                  <svg
                ...
                <a
                  href="https://www.instagram.com/swastikpropertiesofficial/?hl=en"
                  target="_blank"
                  className="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center hover:bg-secondary hover:border-secondary transition-colors"
                >
                  <svg
                ...
                <a
                  href="https://www.linkedin.com/company/swastik-group-builders-developers/?originalSubdomain=in"
                  target="_blank"
                  className="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center hover:bg-secondary hover:border-secondary transition-colors"
                >
                  <svg
