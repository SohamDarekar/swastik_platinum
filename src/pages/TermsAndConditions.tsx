    ...
    <div className="bg-white min-h-screen pt-20 sm:pt-24 pb-16 sm:pb-20">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="font-heading text-3xl sm:text-4xl font-bold mb-6 sm:mb-8">Terms & Conditions</h1>
          ...
          <div className="prose max-w-none text-gray-700 text-sm sm:text-base">
            ...
            <h2 className="font-heading text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 mt-6 sm:mt-8">1. Acceptance of Terms</h2>
            <p className="mb-4">
            ...
            <h2 className="font-heading text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 mt-6 sm:mt-8">2. Use License</h2>
            <p className="mb-4">
            ...
            <h2 className="font-heading text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 mt-6 sm:mt-8">3. Disclaimer</h2>
            <p className="mb-4">
            ...
            <h2 className="font-heading text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 mt-6 sm:mt-8">4. Limitations</h2>
            <p className="mb-4">
            ...
            <h2 className="font-heading text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 mt-6 sm:mt-8">5. Governing Law</h2>
            <p className="mb-4">
