    ...
    <div className="bg-white min-h-screen pt-20 sm:pt-24 pb-16 sm:pb-20">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="font-heading text-3xl sm:text-4xl font-bold mb-6 sm:mb-8">Sitemap</h1>
          
          <div className="prose max-w-none text-gray-700 text-sm sm:text-base">
            <h2 className="font-heading text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 mt-6 sm:mt-8">Main Pages</h2>
            <ul className="space-y-2">
              <li><Link to="/" className="text-secondary hover:underline">Home</Link></li>
            </ul>

            <h2 className="font-heading text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 mt-6 sm:mt-8">Project Sections</h2>
            <ul className="space-y-2">
            ...
            <h2 className="font-heading text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 mt-6 sm:mt-8">Legal Pages</h2>
            <ul className="space-y-2">
            ...
            <h2 className="font-heading text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 mt-6 sm:mt-8">Contact</h2>
            <ul className="space-y-2">
              <li>
            ...
            <h2 className="font-heading text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 mt-6 sm:mt-8">Official Registration</h2>
            <ul className="space-y-2">
              <li>
